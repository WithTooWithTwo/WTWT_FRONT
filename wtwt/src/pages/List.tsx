...
type ListScreenProps = NativeStackScreenProps<MainStackParamList, 'List'>;
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.postZone}>
                        <View style={styles.postBlock}>
                            ...
                            <Text style={styles.titleText}>독일에서 파리로 함께 여행 가실 분!</Text>
                            <Text style={styles.innerText}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et..</Text>
